  ...
  $.mbScrollable= {
    ...
    mbPrevPage: function(auto){
      ...
      if(mbScrollable.idx==1){
       ...
       mbScrollable.scrollTo=0;
      if (mbScrollable.isVertical){
        $(mbScrollable.mbscrollableStrip).animate({marginTop:mbScrollable.scrollTo},mbScrollable.options.noTime);
      }else{
        $(mbScrollable.mbscrollableStrip).animate({marginLeft:mbScrollable.scrollTo},mbScrollable.options.noTime);
      }
      mbScrollable.idx=1;
      $(this).mbManageControls();
    },
    ...
    mbActivateControls: function(){
      var mbScrollable=$(this).get(0);
      var controls=$(mbScrollable.options.controls);
      controls.find(".one").bind("click",function(){$(mbScrollable).goToPage(1, false);});
	   controls.find(".two").bind("click",function(){$(mbScrollable).goToPage(2, false);});
	    controls.find(".three").bind("click",function(){$(mbScrollable).goToPage(3, false);});  
